export const FRONT_ROUTES = {
    "/": "Pagina principal, Lugar de inicio de la aplicación",
    "/login": "Página de inicio de sesión, Donde los usuarios ingresan sus credenciales",
    "/register": "Página de registro, Donde los nuevos usuarios crean una cuenta",
    "/admin": "Página de gestion de contenido, des publicaion y publicacion de productos, activacion de roles de usuarios, Acceso exclusivo para administradores",
    "/MisProductos": "Página de gestion de productos, Acceso exclusivo para vendedores",
    "/MisProductos/Crear": "Página la creacion de un producto, Acceso exclusivo para vendedores",
